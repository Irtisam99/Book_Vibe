    ...
    return (
        <>
            ...
            <div className="mt-10 text-center">
                ...
                <p className="mx-auto mt-3 -mb-4 max-w-2xl text-gray-500">
                    Browse through our collection of amazing books and find
                    something worth adding to your bookshelf.
                </p>
            </div>

            <section className='container mx-auto my-[70px] grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4'>
